...
Before writing code, read `docs-claude/adding-a-feature.md`, both `docs-claude/standards/agnostic/` and `docs-claude/standards/project/` for every technology touched, `docs-claude/repository.md`, and the closest existing feature's code.

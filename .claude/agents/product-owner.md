...
Before writing the brief, skim `README.md`, `CLAUDE.md`, and the `docs-claude/features/*.md` list so you know what already exists — don't describe an existing feature as new, and note if the request is actually an extension of one.

...
- Format multi-line repository/query calls as one method chain and use named arguments for optional update parameters. Bindings use exact domain names and state suffixes (`catalogueItemRowExpected`, `catalogueItemRowUpdated`), matching production naming.

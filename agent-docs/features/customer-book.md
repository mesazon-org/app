...
- Transport: `tapir/FileServiceEndpoints.scala` (existing `extractCustomersFromPhotoPostEndpoint` unchanged; `extractCustomersFromFilePostEndpoint` for `POST /extract/customer-book-file` not yet added), `tapir/tapir.scala`

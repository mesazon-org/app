...
A customer is one of two kinds, discriminated by `customer_type` (see [postgres.md § Customer type](../stack/postgres.md#customer-type--individual-vs-business)):

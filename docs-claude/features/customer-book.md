...
A customer is one of two kinds, discriminated by `customer_type` (see [discriminated subtypes](../standards/agnostic/postgres.md#discriminated-subtypes)):

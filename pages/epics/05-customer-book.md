...
15. Spreadsheet groups preserve their order when combined. Their identified and processed counts are added, their unidentified-entry summaries are combined in group order, and duplicate flags are recalculated across the complete combined candidate list so group boundaries are not visible in the response.

...
//import io.mesazon.gateway.validation.service.{ServiceValidator, WahaServiceValidator}
//import io.mesazon.gateway.{Mocks, smithy}
//import io.mesazon.testkit.base.{IronRefinedTypeArbitraries, ZWordSpecBase}
//import zio.*
//
//class WahaServiceValidatorSpec extends ZWordSpecBase, SmithyArbitraries, IronRefinedTypeArbitraries {
//
//  "WahaServiceValidator" should {
//      "successfully return the validate data" in {

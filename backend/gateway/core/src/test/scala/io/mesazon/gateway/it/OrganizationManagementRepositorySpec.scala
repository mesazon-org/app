  ...
  "OrganizationManagementRepository" when {
    ...
    "updateOrganizationDetails" should {
      "successfully update the organization details" in new TestContext {
        ...
        val emailsOptUpdate                    = arbitrarySample[Option[List[OrganizationEmailEntry]]]
        val phoneNumbersOptUpdate              = arbitrarySample[Option[List[OrganizationPhoneNumberEntry]]]

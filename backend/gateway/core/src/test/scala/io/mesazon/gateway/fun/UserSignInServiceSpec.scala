...
//import io.mesazon.gateway.service.{UserSignInService, UserSignUpService}
...
//    "signInEmail" should {
//      "successfully sign in a user with valid email and password" in new TestContext {}
//    }
//  }
//
//  trait TestContext
...
//      ZIO
//        .service[smithy.UserSignInService[Task]]
//        .provide(

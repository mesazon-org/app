...
trait OrganizationManagementRepository {
  ...
  def updateOrganization(
      ...
      taglineOptUpdate: Option[OrganizationTagline] = None,
      emailsOptUpdate: Option[List[OrganizationEmailEntry]] = None,
      phoneNumbersOptUpdate: Option[List[OrganizationPhoneNumberEntry]] = None,
...
object OrganizationManagementRepository {
  ...
  private final class OrganizationManagementRepositoryImpl(
    ...
    override def updateOrganization(
        ...
        emailsOptUpdate: Option[List[OrganizationEmailEntry]],
        phoneNumbersOptUpdate: Option[List[OrganizationPhoneNumberEntry]],

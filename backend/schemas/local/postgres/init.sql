...
-- Local test user
CREATE USER "local_test_user" WITH PASSWORD 'local_test_password';

GRANT CONNECT ON DATABASE "local_db" TO "local_test_user";
GRANT USAGE ON SCHEMA "local_schema" TO "local_test_user";
ALTER DEFAULT PRIVILEGES FOR USER "flyway" IN SCHEMA "local_schema" GRANT USAGE ON SEQUENCES TO "local_test_user";
ALTER DEFAULT PRIVILEGES FOR USER "flyway" IN SCHEMA "local_schema" GRANT SELECT, INSERT, UPDATE, DELETE, TRUNCATE ON TABLES TO "local_test_user";

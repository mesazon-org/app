...
create type catalogue_item_status as enum ('Active', 'Archived');
...
(
    ...
    price_currency              text,
    image_original_bucket_key   text,
    image_normalized_bucket_key text,
...
create unique index uq_catalogue_item_name
    on catalogue_item (organization_id, name)
    where status = 'Active';

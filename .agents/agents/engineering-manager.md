...
Process:
1. Read `AGENTS.md`, the related `docs-claude/features/*.md`, [feature flow](../../docs-claude/features/flow/README.md), and enough code to understand what exists and where the request fits.

...
3. **Create one when none exists.** Copy [`pages/epics/TEMPLATE.md`](../../pages/epics/TEMPLATE.md), number it after the highest existing epic, list it under [Epics](../../AGENTS.md#epics) in `AGENTS.md`, and add it to `pages/index.md`.
